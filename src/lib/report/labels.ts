...
const L = {
  ...
  certCombinedNote:     { en: 'Combined owner report',
                          he: 'דוח בעלים מאוחד' },
  ...
  stmtCoverTitle:          { en: 'Owner property account statement',       he: 'דוח חשבון נכסים לבעלים' },
  stmtExecTitle:           { en: 'Executive settlement',                   he: 'סיכום התחשבנות' },
  stmtOpenProperties:      { en: 'Total open balances of eight properties', he: 'סה"כ יתרות פתוחות של שמונה הנכסים' },
  stmtSharonCredit:        { en: 'Sharon noncash settlement credit',       he: 'זיכוי שרון (לא מזומן)' },
  stmtGeneralCash:         { en: 'General cash payment',                   he: 'תשלום מזומן כללי' },
  stmtFinalPayableJj:      { en: 'Final payable to JJ',                    he: 'יתרה סופית לתשלום' },
  stmtPropertyList:        { en: 'Property closings',                      he: 'סגירות הנכסים' },
  stmtStatusCard:          { en: 'Property status',                        he: 'סטטוס הנכס' },
  stmtPropertyClosing:     { en: 'Property closing',                       he: 'יתרת הנכס' },
  stmtStateClosed:         { en: 'CLOSED',                                 he: 'סגור' },
  stmtStatePartial:        { en: 'PARTIALLY CLOSED',                       he: 'סגור חלקית' },
  stmtStateOpen:           { en: 'OPEN',                                   he: 'פתוח' },
  stmtLayerClosed:         { en: 'CLOSED',                                 he: 'סגור' },
  stmtLayerPartial:        { en: 'PARTIALLY PAID',                         he: 'שולם חלקית' },
  stmtLayerOpen:           { en: 'OPEN',                                   he: 'פתוח' },
  stmtContractsTitle:      { en: 'Contracts and large projects',           he: 'חוזים ופרויקטים גדולים' },
  stmtLayer:               { en: 'Layer',                                  he: 'שכבה' },
  stmtAgreed:              { en: 'Agreed amount',                          he: 'סכום מוסכם' },
  stmtPaidCredited:        { en: 'Paid / credited',                        he: 'שולם / זוכה' },
  stmtRemaining:           { en: 'Remaining',                              he: 'נותר' },
  stmtOperatingTitle:      { en: 'Operating account',                      he: 'חשבון תפעול' },
  stmtOpCategory:          { en: 'Category',                               he: 'קטגוריה' },
  stmtOpCharges:           { en: 'Charges to owner',                       he: 'חיובים לבעלים' },
  stmtOpCredits:           { en: 'Owner income / credits',                 he: 'הכנסות / זיכויים לבעלים' },
  stmtOpNet:               { en: 'Net effect',                             he: 'השפעה נטו' },
  stmtOpSetup:             { en: 'Setup',                                  he: 'הקמה' },
  stmtOpRecurring:         { en: 'Recurring operations',                   he: 'תפעול שוטף' },
  stmtOpRepairs:           { en: 'Repairs',                                he: 'תקלות ותיקונים' },
  stmtOpLtr:               { en: 'Long-term rental income',                he: 'הכנסות שכירות ארוכה' },
  stmtOpStr:               { en: 'Short-term rental income',               he: 'הכנסות שכירות קצרה' },
  stmtClosingBridge:       { en: 'Closing bridge',                         he: 'גשר סגירה' },
  stmtExplainTitle:        { en: 'Explanation',                            he: 'הסבר' },
  stmtControlTitle:        { en: 'Final control',                          he: 'בקרה סופית' },
  stmtDueToOwner:          { en: 'Payable to the owner',                   he: 'לתשלום לבעלים' },
  stmtDueToJj:             { en: 'Payable to JJ',                          he: 'לתשלום ל-JJ' },
  stmtCash:                { en: 'Cash',                                   he: 'מזומן' },
  stmtNoncash:             { en: 'Noncash',                                he: 'לא מזומן' },
  stmtLayerPurchase:       { en: 'Purchase',                               he: 'רכישה' },
  stmtLayerSale:           { en: 'Sale',                                   he: 'מכירה' },
  stmtLayerRenovation:     { en: 'Renovation',                             he: 'שיפוץ' },
