...
const L = {
  ...
  dashBalance:          { en: 'Property Activity Balance',                  he: 'יתרת פעילות נכס'             },
  ...
  finalCurrentBalance:  { en: 'Property Activity Balance',                 he: 'יתרת פעילות נכס'              },
  ...
  // ─── Gate 2: Certified STR + Counterparty Settlement ──────────────────
  ...
  certifiedStrBalance:      { en: 'Certified STR Property-Period Balance',        he: 'יתרת תקופה — STR מאושר' },
  ...
  settlementTitle:          { en: 'Counterparty Settlement Position',            he: 'עמדת התחשבנות מול צד נגדי' },
  ...
  evidenceSettlementSource: { en: 'Settlement position: Aggregated across all property activity domains (cumulative)',
                              he: 'עמדת התחשבנות: מצטבר, כל תחומי הפעילות' },
