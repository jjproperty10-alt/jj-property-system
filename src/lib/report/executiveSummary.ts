 ...
 *   Purchase sections remain visible per-property for audit transparency but are
 *   excluded from ALL owner-facing balance computations (Owner Summary, Property Net,
 *   Overall Net, PDF hero balance, PDF final summary, Client Report Preview).
 *
