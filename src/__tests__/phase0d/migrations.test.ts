...
const M1 = path.join(__dirname, '..', '..', '..', 'supabase', 'migrations', '20260916_001_v_certified_ledger_and_rc3.sql')
const M2 = path.join(__dirname, '..', '..', '..', 'supabase', 'migrations', '20260916_002_agent_transaction_drafts.sql')
