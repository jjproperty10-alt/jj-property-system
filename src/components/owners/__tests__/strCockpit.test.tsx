...
const cockpit: OwnerStrCockpit = {
  breakdown: [
    { propertyId: 'd', propertyName: 'Tamir Dekelia', confirmed: 3, cancelled: 4, nights: 27, revenueEur: 2839.95, nextCheckIn: '2026-08-02', status: 'active' },
    { propertyId: 'r', propertyName: 'Tamir Radisson', confirmed: 5, cancelled: 3, nights: 17, revenueEur: 1402, nextCheckIn: null, status: 'idle' },
  ],
  reconciliation: [
  ...
  totals: { confirmed: 8, cancelled: 7, nights: 44, revenueEur: 4241.95 },
}
