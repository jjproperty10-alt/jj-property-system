...
export const AVI_REPORT_COPY = {
  en: {
    ...
    airbnbIncomeSubtitle:
      'Private booking income and Hostaway rental income are shown separately. Hostaway uses Net Owner Payout.',
    ...
    approvedChargesNote:
      'Ledger snapshot is 29 August 2026. Hostaway income includes completed stays through 6 September 2026. Setup and operations appear only under expenses.',
  ...
  he: {
    ...
    airbnbIncomeSubtitle:
      'הכנסות מהזמנה פרטית והכנסות Hostaway מוצגות בנפרד. Hostaway לפי תשלום נטו לבעלים (Net Owner Payout).',
    ...
    approvedChargesNote:
      'ספר העסקאות עד 29 באוגוסט 2026. הכנסות Hostaway כוללות שהיות שהושלמו עד 6 בספטמבר 2026. הקמה ותפעול מוצגים רק בסעיפי ההוצאות.',
