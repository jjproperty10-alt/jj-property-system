/* Isolated Postgres tests for 20260919150000.
...
const PORT = process.env.JJ_PG_PORT || '15437'
const CONTAINER = 'jj-identity-reassign-pg'
const MIGRATION = path.join(REPO, 'supabase/migrations/20260919150000_lifecycle_identity_reassignment.sql')
const FORBIDDEN = [
  '2944e9ad',
  '0e2f942b',
  '6d6fe818',
