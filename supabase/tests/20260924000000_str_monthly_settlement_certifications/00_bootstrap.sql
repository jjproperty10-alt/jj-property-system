-- Isolated Postgres stubs for monthly STR settlement certification tests.
-- Not applied to Production. No production client, property, or amount literals.
...
CREATE TABLE IF NOT EXISTS finance.client_settlement_certifications (id uuid PRIMARY KEY);
CREATE TABLE IF NOT EXISTS finance.client_settlement_certification_lines (id uuid PRIMARY KEY);
CREATE TABLE IF NOT EXISTS finance.client_settlement_certification_audit (id uuid PRIMARY KEY);
CREATE TABLE IF NOT EXISTS finance.client_settlement_events (id uuid PRIMARY KEY);
...
INSERT INTO public.property_definitions (property_name, property_id) VALUES
  ('Property Alpha', '12121212-1212-4212-8212-121212121212'),
  ('Property Beta', '13131313-1313-4313-8313-131313131313');
