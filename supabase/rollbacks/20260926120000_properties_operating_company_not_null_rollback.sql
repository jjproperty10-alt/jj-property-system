-- Rollback for 20260926120000_properties_operating_company_not_null.
-- Drops the requirement only in the reviewed clean state.
-- Does not clear company assignments.
