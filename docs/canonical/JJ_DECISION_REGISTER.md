...
| CONS-011 | 2026-08-11 | Knowledge | CLAUDE Dependency Gate RELEASED — zero current-authority CLAUDE.md deps proven (Phase 2B.1); all live authority Git-backed; remaining CLAUDE.md refs = provenance/history. Release does NOT authorize CLAUDE.md deletion/archival; Canonical Knowledge Gate stays ACTIVE. Lean CLAUDE.md refactor authorized as a separate future step (not started). | Yossi (Gate Release) | Approved |
